...
import { Layout, Menu, Dropdown, Button, Row, Col, Modal, Drawer, Divider, Avatar } from 'antd';
...
const AppHeader = (props) => {
    ...
    return (
        <Header id="app_header" style={{ backgroundColor: background, color: mode == 'light' ? '#fff' : '#000' }} className={className}>
            <div className="container" id="app_header--mobile">
                <div className="d-flex justify-content-between align-items-center">
                    <div className="logo">
                        <Link href="/#" >
                            <img src={require(`../public/static/images/logo_${mode}.png`)} alt="2stay" />
                        </Link>
                    </div>
...
export default withTranslation('header')(AppHeader);